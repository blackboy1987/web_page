  ...
  const columns: ColumnProps<TableListItem>[] = [
    {
      ...
      width: 40,
      fixed: 'left',
      render: (text, record, checkIndex7) => <span>{checkIndex7 + 1}</span>,
    },
    {
      title: '年度',
      dataIndex: 'acctYear',
        ...
        <StandardTable
          ...
          title={() => (
            <div className={styles.tableTitle}>
              <span className={styles.title}>其他费用审定</span>
              <div>
...
export default connect(
  ({
    ...
    checkIndex7,
    submitting: loading.effects['checkIndex7/list'],
  }),
)(TableList);
