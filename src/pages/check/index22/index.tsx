  ...
  const columns: ColumnProps<TableListItem>[] = [
    {
      ...
      width: 40,
      fixed: 'left',
      render: (text, record, checkIndex22) => <span>{checkIndex22 + 1}</span>,
    },
    {
      title: '年度',
      dataIndex: 'acctYear',
...
export default connect(
  ({
    ...
    checkIndex22,
    submitting: loading.effects['checkIndex22/list']||loading.effects['checkIndex22/calc']||loading.effects['checkIndex22/download'],
  }),
)(TableList);
