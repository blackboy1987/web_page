  ...
  const columns: ColumnProps<TableListItem>[] = [
    {
      ...
      width: 40,
      fixed: 'left',
      render: (text, record, checkIndex5) => <span>{checkIndex5 + 1}</span>,
    },
    {
      title: '年度',
      dataIndex: 'acctYear',
        ...
        <StandardTable
          ...
          title={() => (
            <div className={styles.tableTitle}>
              <span className={styles.title}>无形资产审定</span>
              <div>
...
export default connect(
  ({
    ...
    checkIndex5,
    submitting: loading.effects['checkIndex5/list'],
  }),
)(TableList);
