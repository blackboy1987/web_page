  ...
  const columns: ColumnProps<TableListItem>[] = [
    {
      ...
      width: 40,
      fixed: 'left',
      render: (text, record, checkIndex9) => <span>{checkIndex9 + 1}</span>,
    },
    {
      title: '年度',
      dataIndex: 'acctYear',
        ...
        <StandardTable
          ...
          title={() => (
            <div className={styles.tableTitle}>
              <span className={styles.title}>全院药事服务费用</span>
              <div>
...
export default connect(
  ({
    ...
    checkIndex9,
    submitting: loading.effects['checkIndex9/list'],
  }),
)(TableList);
