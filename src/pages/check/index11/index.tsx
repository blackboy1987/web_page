  ...
  const columns: ColumnProps<TableListItem>[] = [
    {
      ...
      width: 40,
      fixed: 'left',
      render: (text, record, checkIndex11) => <span>{checkIndex11 + 1}</span>,
    },
    {
      title: '年度',
      dataIndex: 'acctYear',
        ...
        <StandardTable
          ...
          title={() => (
            <div className={styles.tableTitle}>
              <span className={styles.title}>诊查费项目</span>
              <div>
...
export default connect(
  ({
    ...
    checkIndex11,
    submitting: loading.effects['checkIndex11/list'],
  }),
)(TableList);
