...
import { Form, Select, Button,Card,DatePicker,Table } from 'antd';
...
const TableList: React.FC<TableListProps> = ({dispatch,index7,submitting}) => {
  const [height,setHeight] = useState<number>(window.innerHeight-Constants.tableHeiht);
  ...
  useEffect(()=>{
    setHeight(window.innerHeight-Constants.tableHeiht)
  },[height])
          ...
          title={()=>(
            <div className={styles.tableTitle}>
              ...
              <div>
                ...
                <Button type='primary' size='small'>模版下载</Button>
              </div>
            </div>
          )}
          rowKey="levelNum"
